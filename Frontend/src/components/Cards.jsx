...
//   return(
//      <div className={`group h-auto md:h-[300px] lg:h-[320px] flex flex-col bg-white border-2 overflow-hidden cursor-pointer transition-all duration-500 hover:scale-165 hover:shadow-lg rounded-3xl ${isSelected ? 'border-violet-500 shadow-lg shadow-violet-500/20 bg-violet-50':'border-gray-200 hover:border-violet-300'}`} onClick={onSelect}>
//       {thumbnailImg ?(
...
//                 <Check size={24} className='text-violet-600'></Check>
//               </div>
//             </div>
//           )}
...
//          flex-col justify-center bg-gradient-to-br from-violet-50 via-violet-600 to-fuchsia-50'>
...
//             <Edit className='text-white ' size={20}></Edit>
//           </div>
...
export const TemplateCard = ({ thumbnailImg, isSelected, onSelect }) => {
  return (
    <div
      className={`group h-auto md:h-[300px] lg:h-[320px] flex flex-col bg-white border-2 overflow-hidden cursor-pointer transition-all duration-500 rounded-3xl
        ${isSelected 
      ...
      `}
      onClick={onSelect}
      style={{ boxSizing: 'border-box' }} // Ensure box-sizing border-box
    >
      {thumbnailImg ? (
        <div className="relative w-full h-full overflow-hidden">
          <img
